...
- `split` and `split_regex` function are from [Tim Raasveld](https://github.com/timraasveld/ansible-string-split-filter)
...
Initial Author:: [Alexander Jäger](https://github.com/lxhunter)
