...
class TestStringUtlisFunctions(unittest.TestCase):
    ...
    def test_camelize(self):
        self.assertEqual(
            camelize('the_camelize_string_method', False), 'theCamelizeStringMethod')
        self.assertEqual(
            camelize('webkit-transform', False), 'webkitTransform')
        self.assertEqual(camelize('webkit-transform', True), 'WebkitTransform')
        self.assertEqual(
            camelize('-the-camelize-string-method', True), 'TheCamelizeStringMethod')
        self.assertEqual(
            camelize('_the_camelize_string_method'), 'TheCamelizeStringMethod')
        self.assertEqual(
            camelize('The-camelize-string-method'), 'TheCamelizeStringMethod')
        self.assertEqual(
            camelize('the camelize string method', False), 'theCamelizeStringMethod')
        self.assertEqual(
            camelize(' the camelize  string method', False), 'theCamelizeStringMethod')
        self.assertEqual(
            camelize('the camelize   string method', False), 'theCamelizeStringMethod')
        ...
        self.assertEqual(
            camelize(''), '', 'Camelize empty string returns empty string')
        self.assertEqual(
            camelize(None), '', 'Camelize null returns empty string')
    ...
    def test_clean(self):
        ...
        self.assertEqual(
            clean(''), '', 'cleaning empty string returns empty string')
    ...
    def test_dasherize(self):
        ...
        self.assertEqual(
            dasherize('the_dasherize_string_method'), 'the-dasherize-string-method')
        ...
        self.assertEqual(
            dasherize('the dasherize string method'), 'the-dasherize-string-method')
        self.assertEqual(
            dasherize('the  dasherize string method  '), 'the-dasherize-string-method')
    ...
    def test_decapitalize(self):
        self.assertEqual(
            decapitalize('Fabio'), 'fabio', 'First letter is lower case')
        self.assertEqual(
            decapitalize('Fabio'), 'fabio', 'First letter is lower case')
        self.assertEqual(decapitalize('FOO'), 'fOO', 'Other letters unchanged')
        self.assertEqual(decapitalize(123), '123', 'Non string')
        self.assertEqual(
            decapitalize(''), '', 'Decapitalizing empty string returns empty string')
        self.assertEqual(
            decapitalize(None), '', 'Decapitalizing null returns empty string')
    ...
    def test_escape_html(self):
        self.assertEqual(escape_html('<div>Blah & "blah" & \'blah\'</div>'),
                         '&lt;div&gt;Blah &amp; &quot;blah&quot; &amp; &#39;blah&#39;&lt;/div&gt;')
        self.assertEqual(escape_html('&lt;'), '&amp;lt;')
        self.assertEqual(escape_html(' '), ' ')
        self.assertEqual(escape_html('¢'), '&cent;')
        self.assertEqual(
            escape_html('¢ £ ¥ € © ®'), '&cent; &pound; &yen; &euro; &copy; &reg;')
    ...
    def test_ends_with(self):
        ...
        self.assertEqual(ends_with('foobar', 'bar'), True)
        self.assertEqual(ends_with(
            '00018-0000062.Plone.sdh264.1a7264e6912a91aa4a81b64dc5517df7b8875994.mp4', 'mp4'), True)
    ...
    def test_humanize(self):
        self.assertEqual(
            humanize('the_humanize_string_method'), 'The humanize string method')
        self.assertEqual(
            humanize('ThehumanizeStringMethod'), 'Thehumanize string method')
        self.assertEqual(
            humanize('-ThehumanizeStringMethod'), 'Thehumanize string method')
        self.assertEqual(
            humanize('the humanize string method'), 'The humanize string method')
        self.assertEqual(
            humanize('the humanize_id string method_id'), 'The humanize id string method')
        self.assertEqual(
            humanize('the  humanize string method  '), 'The humanize string method')
    ...
    def test_unescape_html(self):
        ...
        self.assertEqual(unescape_html('&nbsp;'), ' ')
        self.assertEqual(unescape_html(
            'what is the &yen; to &pound; to &euro; conversion process?'), 'what is the ¥ to £ to € conversion process?')
        self.assertEqual(unescape_html('&reg; trademark'), '® trademark')
        self.assertEqual(unescape_html(
            '&copy; 1992. License available for 50 &cent;'), '© 1992. License available for 50 ¢')
        self.assertEqual(unescape_html('&nbsp;'), ' ')
        self.assertEqual(unescape_html('&nbsp;'), ' ')
